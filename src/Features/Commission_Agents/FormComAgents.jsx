...
import { getComisionista, createComisionista, updateComisionista } from "../../services/commission_agents.api";

//import '../../components/CSS/FormGeneral.css';
import '../../components/css/CustomForm.css';


export function  ComAgentsForm() {
    ...
    useEffect(() => {
        async function load(){
            if (params.id){
                ...
                const data = await getComisionista(params.id)
                //console.log(data)
                const {
                ...
                <div className="form-rectangulo-head">
                    <div className="title-button-wrapper"> 
                        <div className="title-section">
                            ...
                            <p className="subtitle">Registro de Comisionista</p  >
                        </div>
