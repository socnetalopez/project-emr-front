...
import { getEquipments } from '../../services/equipments.api '; 
...
export function EquipmentList() {
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Make', accessor: 'make.name', Filter: DefaultColumnFilter },
    { Header: 'Model', accessor: 'model.name', Filter: DefaultColumnFilter },
    { Header: 'Serial Number', accessor: 'serialnumber', Filter: DefaultColumnFilter },
    { Header: 'Created', accessor: 'created', Filter: DefaultColumnFilter },
  ], []);
  ...
  function DefaultColumnFilter({ column: { filterValue, setFilter } }) {
    return (
  	...
  	const handleClick = () => {
        navigate('/dashboard/equipments/equipment');
    };

  // Doble clic para navegar
  const handleDoubleClick = (row) => {
    navigate(`/dashboard/equipments/equipment/${row.original.id}`);
  };
  ...
  return (
    <div>
		...
		<div className="banner-rectangulo-sup-flotante">
			<h3> Equipments </h3>
